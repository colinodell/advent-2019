...
- `2234<em>50</em>` does not meet these criteria (decreasing pair of digits `50`).
...
- `123<em>444</em>` no longer meets the criteria (the repeated `44` is part of a larger group of `444`).
